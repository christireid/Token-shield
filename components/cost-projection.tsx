...
const TIERS = [
  { label: "Startup", requests: 10000, avgInput: 500, avgOutput: 200, model: "gpt-4o-mini", inputPrice: 0.15, outputPrice: 0.6 },
  { label: "Growth", requests: 100000, avgInput: 800, avgOutput: 300, model: "gpt-4o", inputPrice: 2.5, outputPrice: 10.0 },
  { label: "Enterprise", requests: 1000000, avgInput: 1200, avgOutput: 500, model: "gpt-4o", inputPrice: 2.5, outputPrice: 10.0 },
]
...
export function CostProjection() {
  ...
  const projection = useMemo(() => {
    ...
    return { costPerRequest, monthlyCost, monthlySaved, monthlyWithShield, yearlySaved, savedPercent }
  }, [tier])
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
          ...
          <div className="rounded-lg border border-border bg-card p-4 sm:p-5">
            ...
            <p className="mt-0.5 text-xs text-muted-foreground">
              ${projection.monthlySaved.toLocaleString(undefined, { maximumFractionDigits: 0 })}/mo saved
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 rounded-lg border border-border bg-card p-4 sm:p-5">
          ...
          <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { module: "Context Manager", pct: "40-70%", desc: "Trim old messages, keep what matters" },
              ...
              { module: "Prefix Optimizer", pct: "50-90%", desc: "Provider-side prompt cache hits" },
              { module: "Circuit Breaker", pct: "caps cost", desc: "Hard limits prevent runaway bills" },
            ].map((item) => (
              <div key={item.module} className="flex items-start gap-2 rounded-md bg-background p-2.5">
