...
async function main() {
  ...
  try {
    ...
    console.log("   (Skipping actual API call due to missing/invalid key, but integration logic is valid)");
  ...
  console.table([
    ...
    { Feature: "Vendor Lock-in", TokenShield: "None (remove lines)", Edgee: "High (infra dependency)" },
