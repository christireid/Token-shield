...
function summarizeEventData(type: string, data: Record<string, unknown>): string {
  try {
    switch (type) {
      case "cache:hit":
...
function ProviderHealthSection({ adapter }: { adapter: ProviderAdapter }) {
...
function PipelineMetricsSection() {
